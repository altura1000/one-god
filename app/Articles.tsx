...
export const articles: Article[] = [
  {
    ...
    content: 
    "One God is a grassroots, non-partisan initiative bringing Jewish and Christian communities together across the United States. Our mission is to strengthen understanding, rebuild trust, and create meaningful connections between people of faith. We believe that every person carries dignity, and that freedom is safeguarded when communities stand together with respect and purpose. Through partnerships between congregations and local leaders, One God fosters dialogue, collaboration, and new opportunities that bridge cultural and spiritual divides. This is the beginning of a growing movement built on shared values and real connection. Step by step, pastors and rabbis, thinkers and creators, come together to shape a stronger, more united America. Join us as we build lasting partnerships and develop initiatives that turn faith and vision into impact."
      // content:
